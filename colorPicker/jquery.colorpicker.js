 ...
 * @attention 之前有样式问题，此版本为个人修复后的文件
 */
(function($) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                ...
                $("#CT tr td").unbind("click").mouseover(function(){
                    ...
                    $("#DisColor").css({background: color, width: '46px', height: '19px'});
        ...
        function initColor(){
            ...
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
                    ...
                    colorTable=colorTable+'<td width=12 rel="#000000" style="background-color:#000000; border:solid #000 1px;">'
                    colorValue = i==0 ? ColorHex[j]+ColorHex[j]+ColorHex[j] : SpColorHex[j];
                    colorTable=colorTable+'<td width=12 rel="#'+colorValue+'" style="background-color:#'+colorValue+'; border:solid #000 1px;">'
                    colorTable=colorTable+'<td width=12 rel="#000000" style="background-color:#000000; border:solid #000 1px;">'
                    for (k=0;k<3;k++){
                        for (l=0;l<6;l++){
            ...
            +'<tr><td width="3"><td><input type="text" id="DisColor" size="6" disabled style="border:solid 1px #000000;background-color:#ffff00; width: 46px; height: 19px;"></td>'
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="font-family:Arial; width: 76px; height: 18px" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a> | <a href="javascript:void(0);" id="_creset" style="font-size: 12px">清除</a></td></tr></table></td></table>'
